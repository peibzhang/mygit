<?php
define('sucms_ADMIN', preg_replace("|[/\\\]{1,}|",'/',dirname(__FILE__) ) );
require_once(sucms_ADMIN."/../include/common.php");
require_once(sucms_INC."/check.admin.php");
require_once(sucms_ADMIN."/coplugins/Snoopy.class.php");
...
{
	require_once(sucms_INC."/ftp.class.php");
	...
	if( $ftp->ftpStatus == 1){;
		$localfile= sucms_ROOT .'/'. $Newpicpath . $picfile;
...
function viewFoot()
{
	...
	echo "</div><div class=\"bottom\"><table width=\"100%\" cellspacing=\"5\"><tr><td align=\"center\">速成影音管理系统,用时".
	($endtime[0]+($endtime[1]-$starttime[1])-$starttime[0])."秒,数据查询".$dsql->QueryTimes()."次</td></tr><tr><td align=\"center\"><a target=\"_blank\" href=\"http://www.sucms.org/\">Powered By SuCms</a></td></tr></table></div>\n</body>\n</html>";
}
