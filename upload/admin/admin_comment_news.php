...
{
	@cache_clear(sucms_ROOT.'/data/cache/review/1');
...
{
	include(sucms_ADMIN.'/templets/admin_comment_news.htm');
	exit();
}
...
function delcommentcache($id)
{
	...
	{
		if(file_exists(sucms_DATA.'/cache/review/1/'.$row['v_id'].'.js'))
		{
			delfile(sucms_DATA.'/cache/review/1/'.$row['v_id'].'.js');
		}
	}
}
